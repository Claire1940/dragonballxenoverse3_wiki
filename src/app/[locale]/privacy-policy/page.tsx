...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - Dragon Ball Xenoverse 3 Wiki',
    description: 'Dragon Ball Xenoverse 3 Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our Dragon Ball Xenoverse 3 fan resource platform. Your privacy matters to us.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Dragon Ball Xenoverse 3 Wiki ("we", "our", or "us") collects minimal information to provide and improve our services.
            ...
            <p>
              Our website may contain links to external websites, including Steam, the PlayStation Store, the Xbox Store, Reddit, and social media platforms.
            ...
            <h2>11. Disclaimer</h2>
            <p>
              Dragon Ball Xenoverse 3 Wiki is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
              with Bandai Namco Entertainment, Dimps, Bird Studio, Shueisha or Toei Animation, the rights holders of Dragon Ball Xenoverse 3. All game content, trademarks, and assets are
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@dragonballxenoverse3.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@dragonballxenoverse3.wiki</a>
            </p>
            <p>
