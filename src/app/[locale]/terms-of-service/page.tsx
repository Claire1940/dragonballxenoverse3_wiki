...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Dragon Ball Xenoverse 3 Wiki",
    description: "Read the Terms of Service for Dragon Ball Xenoverse 3 Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Dragon Ball Xenoverse 3 fan resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Dragon Ball Xenoverse 3 Wiki",
      description: "Terms and conditions for using Dragon Ball Xenoverse 3 Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Dragon Ball Xenoverse 3 Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Dragon Ball Xenoverse 3 Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Dragon Ball Xenoverse 3 Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Dragon Ball Xenoverse 3 Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the game "Dragon Ball Xenoverse 3". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Game guides and combat strategies</li>
              <li>Release date, platform and trailer information</li>
              <li>Story, AGE 1000 and West City content</li>
              <li>Character, race and build guides</li>
              <li>Soul Assist and Soul Switch mechanics</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Dragon Ball Xenoverse 3 Wiki is NOT affiliated with, endorsed by, or associated with
              Bandai Namco Entertainment, Dimps, Bird Studio, Shueisha or Toei Animation. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Dragon Ball Xenoverse 3 Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Bandai Namco Entertainment, Dimps, Bird Studio, Shueisha, Toei Animation and/or other rights holders of Dragon Ball Xenoverse 3. We use such
            ...
            <ul>
              ...
              <li><strong>Release & Update Availability:</strong> Dragon Ball Xenoverse 3 release details, platforms and game updates may change without notice. We are not responsible for release date shifts or game changes.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, DRAGON BALL XENOVERSE 3 WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              The Website may contain links to third-party websites, including Steam, the PlayStation Store, the Xbox Store, Reddit, social media platforms,
            ...
            <p>
              ...
              you and Dragon Ball Xenoverse 3 Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@dragonballxenoverse3.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@dragonballxenoverse3.wiki</a>
            </p>
            <p>
